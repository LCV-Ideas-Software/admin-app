...
**Status.** Stable. Current release: **v02.15.13**. See [CHANGELOG.md](./CHANGELOG.md) for the full release history.
...
| **`v02.15.10`** | **Alerta Scorecard #51 zerado.** Resolve dois advisories que o OSV do Scorecard pega e o `npm audit` não: `sharp`→0.35.3 (override, transitiva dev do wrangler/miniflare) e `gitpython`→3.1.53 no lock Python hashado (Socket Security). |
...
| **`v02.14.04`** | **Supply chain — lock Python reproduzível.** A entrada direta do Socket Security passa a ser rastreada separadamente e gera um lock hashado completo, permitindo atualizações Dependabot coerentes sem omitir dependências transitivas.                                                                                                                                                                                                                                                                                                                                                                             |
