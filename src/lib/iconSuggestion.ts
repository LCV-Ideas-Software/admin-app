...
const ICON_RULES: IconRule[] = [
  ...
  {
    keywords: ['mapa astral', 'astrologia', 'astrology', 'horoscopo', 'horoscope', 'signo', 'zodiac', 'zodiaco'],
    icon: '⭐',
  },
  ...
  {
    keywords: ['autenticacao', 'authentication', 'autenticar', '2fa', 'mfa', 'segundo fator', 'two factor', 'otp'],
    icon: '🔐',
  },
  ...
  {
    keywords: ['email', 'e-mail', 'correio eletronico', 'inbox', 'caixa de entrada', 'resend', 'sendgrid', 'mailgun'],
    icon: '📧',
  },
  { keywords: ['notificacao', 'notification', 'alerta', 'alert', 'aviso', 'push notification'], icon: '🔔' },
  {
    keywords: ['chat', 'conversa', 'conversation', 'mensagem instantanea', 'whatsapp', 'telegram', 'slack'],
    icon: '💬',
  },
  ...
  {
    keywords: ['auditoria', 'audit', 'log de acesso', 'access log', 'trilha', 'trail', 'historico', 'history'],
    icon: '📋',
  },
  {
    keywords: ['grafico de crescimento', 'growth chart', 'tendencia de alta', 'uptrend', 'crescimento', 'growth'],
    icon: '📈',
  },
  ...
  {
    keywords: ['configuracao', 'configuration', 'config', 'configurar', 'preferencias', 'preferences', 'settings'],
    icon: '⚙️',
  },
  {
    keywords: ['integracao', 'integration', 'webhook', 'api gateway', 'conector', 'connector', 'conexao', 'connection'],
    icon: '🔌',
  },
  ...
  {
    keywords: ['pipeline', 'ci cd', 'github actions', 'build', 'continuous integration', 'continuous deployment'],
    icon: '🚀',
  },
  ...
  {
    keywords: ['banco de dados', 'database', 'db', 'sql', 'mysql', 'postgres', 'postgresql', 'sqlite', 'd1', 'r2'],
    icon: '🗄️',
  },
  ...
  {
    keywords: ['permissao', 'permission', 'role', 'cargo', 'nivel de acesso', 'access level', 'privilegio'],
    icon: '🎖️',
  },
  {
    keywords: ['empresa', 'company', 'organizacao', 'organization', 'negocio', 'business', 'corporativo', 'corporate'],
    icon: '🏢',
  },
  { keywords: ['parceiro', 'partner', 'parceria', 'partnership', 'afiliado', 'affiliate'], icon: '🤝' },
  {
    keywords: ['premio', 'award', 'conquista', 'achievement', 'certificacao', 'certification', 'medalha', 'medal'],
    icon: '🏆',
  },
  ...
  {
    keywords: ['loja', 'shop', 'store', 'produto', 'product', 'catalogo', 'catalog', 'estoque', 'inventory'],
    icon: '🛒',
  },
  ...
  {
    keywords: ['redes sociais', 'social media', 'instagram', 'facebook', 'twitter', 'linkedin', 'tiktok', 'youtube'],
    icon: '📣',
  },
