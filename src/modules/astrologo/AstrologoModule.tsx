        ...
        <div className="admin-modal-overlay" role="dialog" aria-modal="true" aria-label="Confirmar exclusão">
          <div className="admin-modal-content">
            ...
            <div className="admin-modal-header">
              ...
              <p className="admin-modal-subtitle">Você está prestes a expurgar o registro de <strong>{confirmDelete.nome}</strong>. Esta ação não poderá ser desfeita.</p>
            </div>
            <div className="admin-modal-form">
              <div className="admin-modal-actions">
                <button type="button" className="admin-modal-btn admin-modal-btn--ghost" onClick={() => setConfirmDelete(null)}>
                  Cancelar
                </button>
                <button type="button" className="admin-modal-btn admin-modal-btn--danger" onClick={() => void executeDeleteMapa(confirmDelete.id)}>
                  Apagar
                </button>
              </div>
            </div>
