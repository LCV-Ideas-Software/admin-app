        ...
        <div className="admin-modal-overlay" role="dialog" aria-modal="true" aria-label="Confirmar exclusão">
          <div className="admin-modal-content">
            ...
            <div className="admin-modal-header">
              <div className="admin-modal-icon admin-modal-icon--danger"><Trash2 size={24} /></div>
              <h2 className="admin-modal-title">Excluir registro</h2>
              <p className="admin-modal-subtitle">{confirmDelete.label}</p>
            </div>
            <div className="admin-modal-form">
              <div className="admin-modal-actions">
                <button type="button" className="admin-modal-btn admin-modal-btn--ghost" onClick={() => setConfirmDelete(null)}>Cancelar</button>
                <button type="button" className="admin-modal-btn admin-modal-btn--danger" onClick={() => void executeDelete(confirmDelete.id)}>Apagar</button>
              </div>
            </div>
          </div>
        </div>,
