...
const SecretsManager: React.FC<{ domainType: 'worker' | 'page'; resourceId: string; adminActor: string }> = ({
  domainType,
  resourceId,
  adminActor,
}) => {
    ...
    try {
      ...
      const body =
        deleteTarget.type === 'worker'
          ? { scriptName: expected, confirmation: expected }
          : { projectName: expected, confirmation: expected };
      ...
      <div className="cfpw-detail-view">
        <div className="cfpw-detail-view-header">
          ...
          <div className="cfpw-detail-view-header-content">
            <h2>
              {details.id} {detailsLoading && <Loader2 size={16} className="spin" />}
            </h2>
        ...
        <div className="page-tab-nav" style={{ padding: '0 32px' }}>
          <button
            type="button"
            className={`page-tab-item ${activeTab === 'deployments' ? 'active' : ''}`}
            onClick={() => setActiveTab('deployments')}
          >
            Deployments & Visão Geral
          </button>
          <button
            type="button"
            className={`page-tab-item ${activeTab === 'settings' ? 'active' : ''}`}
              ...
              <div className="cfpw-detail-section">
                ...
                {detailDeployments.length > 0 ? (
                  <div className="cfpw-deploy-list">
                    {detailDeployments.slice(0, 15).map((deployment) => {
              ...
              {details.type === 'page' && (
                <>
                  <div className="cfpw-detail-kpi">
                    ...
                    <strong>
                      {((details.payload as PageDetailsPayload).project?.domains as unknown[])?.length || 0}
                    </strong>
                  </div>
                  <div className="cfpw-detail-kpi" style={{ marginTop: '12px' }}>
                    <span>Branch de Produção</span>
                    <strong>
                      {String((details.payload as PageDetailsPayload).project?.production_branch || 'N/A')}
                    </strong>
                  </div>
                </>
              )}
              {details.type === 'worker' && (
                <>
                  ...
                  <div className="cfpw-detail-kpi" style={{ marginTop: '12px' }}>
                    ...
                    <strong>
                      {String((details.payload as WorkerDetailsPayload).worker?.compatibility_date || 'N/A')}
                    </strong>
                  </div>
                </>
              )}
  ...
  const renderOpsModal = () => {
    ...
    return createPortal(
      ...
      <div
        ...
        onClick={() => {
          if (!opsLoading) setOpsModalOpen(false);
        }}
        onKeyDown={(e) => {
          if (e.key === 'Escape' && !opsLoading) setOpsModalOpen(false);
        }}
      >
        ...
        <div className="cfpw-modal" onClick={(e) => e.stopPropagation()} onKeyDown={(e) => e.stopPropagation()}>
          <div className="cfpw-modal-header">
            ...
            <button type="button" className="cfpw-modal-close" onClick={() => setOpsModalOpen(false)}>
              <RefreshCw size={20} />
            </button>
          </div>
              ...
              {visibleFields.has('deploymentId') && (
                <div className="field-group cfpw-ops-grid-full">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('deploymentId', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
              {visibleFields.has('domainName') && (
                <div className="field-group cfpw-ops-grid-full">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('domainName', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
              {visibleFields.has('secretName') && (
                <div className="field-group">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('secretName', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
                ...
                <div className="field-group">
                  ...
                  <div className="cfpw-secret-wrap">
                    <input
                      ...
                      onChange={(e) => updateOpsState('secretValue', e.target.value)}
                      disabled={opsLoading}
                    />
              ...
              {visibleFields.has('usageModel') && (
                <div className="field-group">
                  ...
                  <select
                    ...
                    onChange={(e) => updateOpsState('usageModel', e.target.value)}
                  >
              ...
              {visibleFields.has('schedules') && (
                <div className="field-group cfpw-ops-grid-full">
                  ...
                  <textarea
                    ...
                    onChange={(e) => updateOpsState('schedulesRaw', e.target.value)}
                  />
                </div>
              )}
              {visibleFields.has('pageSettingsJson') && (
                <div className="field-group cfpw-ops-grid-full">
                  ...
                  <textarea
                    ...
                    onChange={(e) => updateOpsState('pageSettingsJson', e.target.value)}
                  />
                </div>
              )}
              {visibleFields.has('routePattern') && (
                <div className="field-group cfpw-ops-grid-full">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('routePattern', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
              {visibleFields.has('zoneId') && (
                <div className="field-group">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('zoneId', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
              {visibleFields.has('routeId') && (
                <div className="field-group">
                  ...
                  <input
                    ...
                    onChange={(e) => updateOpsState('routeId', e.target.value)}
                    disabled={opsLoading}
                  />
                </div>
              )}
          ...
          <div className="cfpw-modal-footer">
            <button type="button" className="ghost-button" onClick={() => setOpsModalOpen(false)} disabled={opsLoading}>
              Fechar
            </button>
            <button
              type="button"
              className="primary-button"
              onClick={() => executeAdvancedOp(selectedOp)}
              disabled={opsLoading}
            >
    ...
    return createPortal(
      <div className="cfpw-modal-overlay">
        <div className="cfpw-modal" style={{ maxWidth: '400px' }}>
          ...
          <div className="cfpw-modal-footer">
            <button type="button" className="ghost-button" onClick={() => setDeleteTarget(null)} disabled={deleting}>
              Cancelar
            </button>
            <button
              type="button"
