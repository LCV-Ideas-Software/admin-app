...
const APP_VERSION = 'APP v01.12.00'
...
type ModuleId = 'overview' | 'astrologo' | 'itau' | 'mainsite' | 'mtasts'
          ...
          <>
            ...
            <section className="metrics-grid">
              <article className="metric-card">
                ...
                <span>Astrólogo, Itaú, MainSite e MTA-STS planejados no shell.</span>
              </article>
              <article className="metric-card">
