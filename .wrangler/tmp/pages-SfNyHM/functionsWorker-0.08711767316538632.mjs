...
async function onRequestPost2(context2) {
  ...
  try {
    ...
    if (!isValidEmail(emailDestino)) {
      return json({ ok: false, error: "E-mail de destino inv\xE1lido.", ...trace3 }, 400);
    }
    if (!relatorioHtml && !relatorioTexto) {
      return json({ ok: false, error: "Relat\xF3rio vazio.", ...trace3 }, 400);
    }
    if (!env2.RESEND_API_KEY) {
      return json({ ok: false, error: "RESEND_API_KEY n\xE3o configurada no runtime.", ...trace3 }, 503);
    }
    ...
    if (!resendResponse.ok) {
      ...
      return json({ ok: false, error: message, ...trace3 }, 502);
    }
    if (env2.BIGDATA_DB) {
      try {
        await logModuleOperationalEvent(env2.BIGDATA_DB, {
    ...
    return json({ ok: false, error: message, ...trace3 }, 500);
  }
}
var json, isValidEmail;
var init_enviar_email = __esm({
  "api/astrologo/enviar-email.ts"() {
    ...
    init_admin_actor();
    init_request_trace();
    json = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
      status,
      headers: toHeaders()
    }), "json");
...
async function onRequestPost3(context2) {
  ...
  if (!db) {
    return json2({ ok: false, error: "Nenhum binding D1 dispon\xEDvel (BIGDATA_DB).", ...trace3 }, 503);
  }
  try {
    const body = await context2.request.json();
    const adminActor = resolveAdminActorFromRequest(context2.request, body);
    ...
    if (!id) {
      return json2({ ok: false, error: "ID inv\xE1lido.", ...trace3 }, 400);
    }
    ...
    return json2({ ok: true, id, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
    ...
    return json2({ ok: false, error: message, ...trace3 }, 500);
  }
}
var json2, resolveDb, resolveOperationalSource;
var init_excluir = __esm({
  "api/astrologo/excluir.ts"() {
    ...
    init_admin_actor();
    init_request_trace();
    json2 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
      status,
      headers: toHeaders()
    }), "json");
...
async function onRequestPost4(context2) {
  ...
  if (!db) {
    return json3({ ok: false, error: "Nenhum binding D1 dispon\xEDvel (BIGDATA_DB).", ...trace3 }, 503);
  }
  try {
    const body = await context2.request.json();
    const adminActor = resolveAdminActorFromRequest(context2.request, body);
    const id = String(body.id ?? "").trim();
    if (!id) {
      return json3({ ok: false, error: "ID inv\xE1lido.", ...trace3 }, 400);
    }
    ...
    `).bind(id).first();
    if (!mapa) {
      return json3({ ok: false, error: "Mapa n\xE3o encontrado.", ...trace3 }, 404);
    }
    if (context2.env.BIGDATA_DB) {
      try {
        await logModuleOperationalEvent(context2.env.BIGDATA_DB, {
    ...
    return json3({ ok: false, error: message, ...trace3 }, 500);
  }
}
var json3, resolveDb2, resolveOperationalSource2;
var init_ler = __esm({
  "api/astrologo/ler.ts"() {
    "use strict";
    init_functionsRoutes_0_2367719624264596();
    ...
    init_admin_actor();
    init_request_trace();
    json3 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
      status,
      headers: toHeaders()
    }), "json");
...
async function onRequestGet6(context2) {
  ...
  if (!db) {
    return json5({ ok: false, error: "Nenhum binding D1 dispon\xEDvel (BIGDATA_DB).", ...trace3 }, 503);
  }
  try {
    ...
    return json5({ ok: true, policies, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
...
async function onRequestPost5(context2) {
  ...
  const source = resolveOperationalSource3(context2);
  if (!db) {
    return json5({ ok: false, error: "Nenhum binding D1 dispon\xEDvel (ASTROLOGO_SOURCE_DB/BIGDATA_DB).", ...trace3 }, 503);
  }
  try {
    const body = await context2.request.json();
    const adminActor = resolveAdminActorFromRequest(context2.request, body);
    ...
    if (!route) {
      return json5({ ok: false, error: "Rota de rate limit inv\xE1lida.", ...trace3 }, 400);
    }
    ...
    if (action === "restore_default") {
      ...
      return json5({ ok: true, action: "restore_default", policies: policies2, admin_actor: adminActor, ...trace3 });
    }
    ...
    if (maxRequests > 500 || windowMinutes > 1440) {
      return json5({ ok: false, error: "Par\xE2metros fora da faixa permitida.", ...trace3 }, 400);
    }
    await upsertRateLimitPolicy(db, {
      route,
      enabled,
    ...
    return json5({ ok: true, action: "update", policies, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
...
var json5, normalizeRoute, toPositiveInt, buildFallbackPolicies, resolveRateLimitDb, resolveOperationalSource3;
...
var onRequestGet7, onRequestDelete;
  ...
  try {
    ...
    const scanResults = await Promise.all(
      projects.map(async (project) => {
        ...
        try {
          const deployments = await listCloudflarePagesDeployments(context2.env, accountId, projectName);
...
async function onRequestPost8(context2) {
  try {
    ...
    const { accountId } = await resolveCloudflarePwAccount(context2.env);
    await deleteCloudflarePagesDeployment(context2.env, accountId, projectName, deploymentId);
...
var normalizeSumupStatus, resolveSumupStatusFromSources, onRequestGet14;
var init_financeiro = __esm({
  "api/financeiro/financeiro.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    normalizeSumupStatus = /* @__PURE__ */ __name((status) => {
    ...
    resolveSumupStatusFromSources = /* @__PURE__ */ __name((rowStatus, rawPayload) => {
    ...
    onRequestGet14 = /* @__PURE__ */ __name(async (context2) => {
      const db = context2.env.BIGDATA_DB;
      const url = new URL(context2.request.url);
      ...
      try {
        ...
        const normalizedLogs = (logsResult.results ?? []).map((log3) => {
          if (String(log3.method || "").trim().toLowerCase() !== "sumup_card") return log3;
          return {
            ...log3,
            status: resolveSumupStatusFromSources(log3.status, log3.raw_payload)
          };
        });
        return Response.json({
          ok: true,
...
var FINANCIAL_CUTOFF_BRT, FINANCIAL_CUTOFF_DATE, FINANCIAL_CUTOFF_UTC, FINANCIAL_CUTOFF_ISO, getStartIsoWithCutoff, isOnOrAfterCutoff, onRequestGet15;
var init_insights = __esm({
  "api/financeiro/insights.ts"() {
    ...
    onRequestGet15 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
...
var FINANCIAL_CUTOFF_DB_UTC, getStartDbWithCutoff, onRequestGet16;
...
var import_mercadopago, onRequestPost12;
...
var import_mercadopago2, onRequestPost13;
...
var import_mercadopago3, FINANCIAL_CUTOFF_BRT2, FINANCIAL_CUTOFF_UTC2, FINANCIAL_CUTOFF_ISO2, FINANCIAL_CUTOFF_DB_UTC2, onRequestPost14;
  ...
  "api/financeiro/mp-sync.ts"() {
    ...
    onRequestPost14 = /* @__PURE__ */ __name(async (context2) => {
      ...
      try {
        ...
        for (const log3 of localLogs) {
          const paymentId = String(log3.payment_id || "").trim();
...
var normalizeSumupStatus2, resolveSumupStatusFromSources2, normalizeMPStatus, onRequestPost15;
var init_reindex_gateways = __esm({
  "api/financeiro/reindex-gateways.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    normalizeSumupStatus2 = /* @__PURE__ */ __name((status) => {
      const s = String(status || "").trim().toUpperCase();
      if (!s) return "UNKNOWN";
      const map = {
        PAID: "SUCCESSFUL",
    ...
    resolveSumupStatusFromSources2 = /* @__PURE__ */ __name((rowStatus, payloadStatus) => {
    ...
    normalizeMPStatus = /* @__PURE__ */ __name((status, statusDetail) => {
...
var FINANCIAL_CUTOFF_DB_UTC3, getStartDbWithCutoff2, onRequestGet17;
...
var updateSumupLogStatus, onRequestPost16;
var init_sumup_cancel = __esm({
  "api/financeiro/sumup-cancel.ts"() {
    ...
    init_performance2();
    init_dist();
    updateSumupLogStatus = /* @__PURE__ */ __name(async (db, checkoutId, transactionId, status, rawPayload) => {
...
var updateSumupLogStatus2, onRequestPost17;
var init_sumup_refund = __esm({
  "api/financeiro/sumup-refund.ts"() {
    ...
    init_performance2();
    init_dist();
    updateSumupLogStatus2 = /* @__PURE__ */ __name(async (db, checkoutId, transactionId, status) => {
      await db.prepare(
...
var FINANCIAL_CUTOFF_BRT3, FINANCIAL_CUTOFF_UTC3, isOnOrAfterCutoff2, normalizeSumupStatus3, resolveSumupStatusFromSources3, onRequestPost18;
var init_sumup_sync = __esm({
  "api/financeiro/sumup-sync.ts"() {
    ...
    isOnOrAfterCutoff2 = /* @__PURE__ */ __name((value) => {
      if (!value) return false;
      const parsed = new Date(value);
      if (Number.isNaN(parsed.getTime())) return false;
      return parsed.getTime() >= FINANCIAL_CUTOFF_UTC3.getTime();
    }, "isOnOrAfterCutoff");
    normalizeSumupStatus3 = /* @__PURE__ */ __name((status) => {
      const s = String(status || "").trim().toUpperCase();
      if (!s) return "UNKNOWN";
      const map = {
        PAID: "SUCCESSFUL",
    ...
    resolveSumupStatusFromSources3 = /* @__PURE__ */ __name((rowStatus, payloadStatus) => {
    ...
    onRequestPost18 = /* @__PURE__ */ __name(async (context2) => {
      const db = context2.env.BIGDATA_DB;
      const token = context2.env.SUMUP_API_KEY_PRIVATE;
...
async function onRequestPost19(context2) {
  ...
  try {
    ...
    if (validations.length) {
      return json7({ ok: false, error: validations[0], ...trace3 }, 400);
    }
    const values = {
...
var json7, resolveParametrosDb, resolveOperationalSource4;
...
async function onRequestGet21(context2) {
  ...
  if (!db) {
    return json8({ ok: false, error: "Nenhum binding D1 dispon\xEDvel (BIGDATA_DB).", ...trace3 }, 503);
  }
  try {
    ...
    return json8({ ok: false, error: message, ...trace3 }, 500);
  }
}
async function onRequestPost20(context2) {
  ...
  try {
    ...
    if (!routeKey) {
      return json8({ ok: false, error: "Rota de rate limit inv\xE1lida.", ...trace3 }, 400);
    }
    const action = String(body.action ?? "update").trim();
    if (action === "restore_default") {
      ...
      return json8({ ok: true, action: "restore_default", policies: policies2, admin_actor: adminActor, ...trace3 });
    }
    const enabled = body.enabled ? 1 : 0;
    ...
    if (maxRequests > 5e3 || windowMinutes > 1440) {
      return json8({ ok: false, error: "Par\xE2metros fora da faixa permitida.", ...trace3 }, 400);
    }
    await upsertRateLimitPolicy2(db, {
      routeKey,
      enabled,
    ...
    return json8({ ok: true, action: "update", policies, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
...
var json8, normalizeRoute2, toPositiveInt3, resolveRateLimitDb2, resolveOperationalSource5;
var init_rate_limit2 = __esm({
  "api/itau/rate-limit.ts"() {
    ...
    init_admin_actor();
    init_request_trace();
    json8 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
      status,
      headers: toHeaders13()
    }), "json");
...
var EXTERNAL_MEDIA_PATTERN, INTERNAL_MEDIA_PREFIX, onRequestPost22;
var init_migrate_media_urls = __esm({
  "api/mainsite/migrate-media-urls.ts"() {
    ...
    onRequestPost22 = /* @__PURE__ */ __name(async (context2) => {
      const db = context2.env.BIGDATA_DB;
      if (!db) {
...
async function onRequestPut3(context2) {
  ...
  try {
    ...
    await db.prepare("UPDATE mainsite_posts SET title = ?, content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(title2, content, id).run();
    const row = await db.prepare(`
      SELECT id, title, content, created_at, is_pinned
      FROM mainsite_posts
      WHERE id = ?
...
var parseId, parseText, mapPostRow, buildErrorResponse3, requireDb;
...
async function onRequestGet24(context2) {
  ...
  try {
    ...
    return json9({ ok: false, error: message, ...trace3 }, 502);
  }
}
  ...
  try {
    ...
    if (action === "restore_default") {
      ...
      if (maxRequests === null || windowMinutes === null) {
        return json9({ ok: false, error: "Par\xE2metros de rate limit inv\xE1lidos.", ...trace3 }, 400);
      }
    ...
    return json9({ ok: true, action, policies, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
...
var POLICY_LIMITS, POLICY_META, ROUTES, json9, toBoolean, parsePositiveInt, normalizeBucket, normalizeConfig, toClientPolicies, loadLegacyRateLimit, saveLegacyRateLimit, normalizeRoute3;
...
async function onRequestPost27(context2) {
  ...
  try {
    const [postsCountRow, financialCountRow, settingsRowsRaw] = await Promise.all([
      ...
      env2.BIGDATA_DB.prepare("SELECT COUNT(1) AS total FROM mainsite_financial_logs").first(),
...
var init_discover = __esm({
  "api/news/discover.ts"() {
    ...
    onRequestGet29 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
...
var RSS_SOURCES, DEFAULT_MAX_ITEMS, CACHE_TTL_SECONDS, onRequestGet30;
var init_feed = __esm({
  "api/news/feed.ts"() {
    "use strict";
    init_functionsRoutes_0_2367719624264596();
    ...
    onRequestGet30 = /* @__PURE__ */ __name(async (context2) => {
      const url = new URL(context2.request.url);
...
var onRequestGet31, onRequestPut5;
var init_cron = __esm({
  "api/oraculo/cron.ts"() {
    "use strict";
    init_functionsRoutes_0_2367719624264596();
    ...
    onRequestGet31 = /* @__PURE__ */ __name(async ({ env: env2 }) => {
...
var init_listar2 = __esm({
  "api/oraculo/listar.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    onRequestGet32 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
      const url = new URL(request.url);
...
var init_modelos3 = __esm({
  "api/oraculo/modelos.ts"() {
    ...
    init_performance2();
    __name(json11, "json");
    onRequestGet33 = /* @__PURE__ */ __name(async ({ env: env2 }) => {
      const apiKey = env2?.GEMINI_API_KEY;
...
async function onRequestGet34(context2) {
  ...
  try {
    ...
    return json12({ ok: true, policies, admin_actor: adminActor, ...trace3 });
  } catch (error3) {
...
var json12, normalizeRoute4, toPositiveInt4, buildFallbackPolicies2, resolveRateLimitDb3, resolveOperationalSource6;
...
var init_taxacache = __esm({
  "api/oraculo/taxacache.ts"() {
    ...
    onRequestGet35 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
      const db = env2?.BIGDATA_DB;
      if (!db || typeof db.prepare !== "function")
...
var onRequestGet36, onRequestDelete5;
var init_userdata2 = __esm({
  "api/oraculo/userdata.ts"() {
    ...
    onRequestGet36 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
      const db = env2?.BIGDATA_DB;
      if (!db || typeof db.prepare !== "function") {
    ...
    onRequestDelete5 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
      const db = env2?.BIGDATA_DB;
      if (!db || typeof db.prepare !== "function") {
        return jsonResponse3({ ok: false, error: "BIGDATA_DB indispon\xEDvel." }, 503);
      }
...
async function onRequestGet37(context2) {
  const { env: env2 } = context2;
  const trace3 = createResponseTrace(context2.request);
  if (!env2.BIGDATA_DB) {
    return new Response(JSON.stringify({
...
async function onRequestGet38(context2) {
  const { env: env2 } = context2;
  const trace3 = createResponseTrace(context2.request);
  const db = env2.BIGDATA_DB;
  if (!db) {
...
// ../.wrangler/tmp/bundle-ZMe5Bj/middleware-loader.entry.ts
init_functionsRoutes_0_2367719624264596();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-ZMe5Bj/middleware-insertion-facade.js
init_functionsRoutes_0_2367719624264596();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.08711767316538632.mjs.map
