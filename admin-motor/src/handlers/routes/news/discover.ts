...
const DIRECTORY: DirectoryEntry[] = [
  // Brasil — Geral
  {
    ...
    category: 'Brasil',
    tags: ['globo', 'brasil', 'notícias', 'geral'],
  },
  {
    id: 'folha',
    ...
    category: 'Brasil',
    tags: ['folha', 'são paulo', 'jornal', 'brasil'],
  },
  {
    id: 'uol',
    name: 'UOL Notícias',
  ...
  },
  {
    ...
    category: 'Brasil',
    tags: ['estadão', 'estado', 'são paulo', 'jornal'],
  },
  {
    id: 'cnn-brasil',
    name: 'CNN Brasil',
  ...
  },
  {
    ...
    category: 'Brasil',
    tags: ['band', 'bandeirantes', 'notícias'],
  },
  {
    id: 'agencia-brasil',
    name: 'Agência Brasil',
    ...
    category: 'Brasil',
    tags: ['ebc', 'governo', 'agência', 'oficial'],
  },
  {
    id: 'terra',
    name: 'Terra',
  ...
  },
  {
    ...
    category: 'Brasil',
    tags: ['metrópoles', 'brasília', 'notícias', 'política'],
  },
  {
    id: 'poder360',
    name: 'Poder360',
    ...
    category: 'Brasil',
    tags: ['poder360', 'política', 'brasília', 'governo'],
  },
  {
    ...
    category: 'Brasil',
    tags: ['correio', 'braziliense', 'brasília', 'df'],
  },
  {
    id: 'ig',
    name: 'iG',
    url: 'https://ultimosegundo.ig.com.br/rss.xml',
    category: 'Brasil',
    tags: ['ig', 'último segundo', 'notícias'],
  },
  {
    id: 'carta-capital',
    name: 'CartaCapital',
    ...
    category: 'Brasil',
    tags: ['carta capital', 'opinião', 'política', 'análise'],
  },
  {
    id: 'nexo',
    name: 'Nexo Jornal',
    url: 'https://www.nexojornal.com.br/feed/',
    category: 'Brasil',
    tags: ['nexo', 'jornal', 'análise', 'explicação'],
  },
  {
    id: 'intercept',
    ...
    category: 'Brasil',
    tags: ['intercept', 'investigação', 'jornalismo'],
  },
  {
    id: 'bbc-brasil',
    name: 'BBC Brasil',
    ...
    category: 'Brasil',
    tags: ['bbc', 'internacional', 'mundo', 'londres', 'brasil'],
  },
  {
    id: 'dw-brasil',
    name: 'DW Brasil',
    url: 'https://rss.dw.com/rdf/rss-br',
    category: 'Brasil',
    tags: ['dw', 'alemanha', 'brasil', 'portuguese'],
  },
  {
    id: 'huffpost-br',
    name: 'HuffPost Brasil',
    url: 'https://www.huffpostbrasil.com/feeds/index.xml',
    category: 'Brasil',
    tags: ['huffpost', 'huffington', 'brasil'],
  },
  // Política
  {
    id: 'g1-politica',
    ...
    category: 'Política',
    tags: ['globo', 'política', 'governo', 'congresso'],
  },
  {
    id: 'folha-poder',
    name: 'Folha Poder',
    ...
    category: 'Política',
    tags: ['folha', 'política', 'poder', 'governo'],
  },
  {
    id: 'congresso-foco',
    ...
    category: 'Política',
    tags: ['congresso', 'senado', 'câmara', 'deputados'],
  },
  {
    id: 'jota',
    name: 'JOTA',
    ...
    category: 'Política',
    tags: ['jota', 'jurídico', 'stf', 'legislação', 'direito'],
  },
  // Economia
  {
    id: 'g1-economia',
    ...
    category: 'Economia',
    tags: ['globo', 'economia', 'mercado', 'finanças'],
  },
  {
    id: 'folha-mercado',
    name: 'Folha Mercado',
    ...
    category: 'Economia',
    tags: ['folha', 'mercado', 'economia', 'bolsa'],
  },
  {
    id: 'valor-economico',
    ...
    category: 'Economia',
    tags: ['valor', 'econômico', 'finanças', 'mercado', 'bolsa'],
  },
  {
    id: 'infomoney',
    name: 'InfoMoney',
    ...
    category: 'Economia',
    tags: ['infomoney', 'investimentos', 'bolsa', 'finanças', 'ações'],
  },
  {
    id: 'exame',
    name: 'Exame',
    ...
    category: 'Economia',
    tags: ['exame', 'negócios', 'economia', 'empresas'],
  },
  {
    id: 'investing',
    ...
    category: 'Economia',
    tags: ['investing', 'câmbio', 'ações', 'bolsa', 'mercado'],
  },
  {
    id: 'bloomberg',
    name: 'Bloomberg',
    ...
    category: 'Economia',
    tags: ['bloomberg', 'markets', 'finance', 'stocks'],
  },
  {
    id: 'cnbc',
    name: 'CNBC',
    ...
    category: 'Economia',
    tags: ['cnbc', 'finance', 'markets', 'economy'],
  },
  {
    id: 'bloomberg-linea',
    ...
    category: 'Economia',
    tags: ['bloomberg', 'línea', 'brasil', 'economia', 'latam'],
  },
  {
    id: 'money-times',
    name: 'Money Times',
    ...
    category: 'Economia',
    tags: ['money', 'times', 'investimentos', 'mercado'],
  },
  {
    id: 'seu-dinheiro',
    name: 'Seu Dinheiro',
    ...
    category: 'Economia',
    tags: ['dinheiro', 'finanças pessoais', 'investimentos'],
  },
  {
    id: 'sunoresearch',
    name: 'Suno Research',
    ...
    category: 'Economia',
    tags: ['suno', 'research', 'dividendos', 'fiis', 'ações'],
  },
  {
    id: 'forbes-br',
    name: 'Forbes Brasil',
    ...
    category: 'Economia',
    tags: ['forbes', 'bilionários', 'negócios', 'empreendedorismo'],
  },
  {
    id: 'ft',
    ...
    category: 'Economia',
    tags: ['ft', 'financial times', 'finance', 'world'],
  },
  {
    id: 'wsj',
    ...
    category: 'Economia',
    tags: ['wsj', 'wall street', 'finance', 'markets'],
  },
  {
    id: 'economist',
    name: 'The Economist',
    ...
    category: 'Economia',
    tags: ['economist', 'economics', 'finance', 'world'],
  },
  {
    id: 'marketwatch',
    name: 'MarketWatch',
    ...
    category: 'Economia',
    tags: ['marketwatch', 'stocks', 'markets', 'finance'],
  },
  // Tecnologia
  {
    id: 'g1-tecnologia',
    ...
    category: 'Tecnologia',
    tags: ['globo', 'tecnologia', 'tech', 'gadgets'],
  },
  {
    id: 'folha-tec',
    name: 'Folha Tec',
  ...
  },
  {
    ...
    category: 'Tecnologia',
    tags: ['tecmundo', 'tecnologia', 'gadgets', 'games'],
  },
  {
    id: 'olhar-digital',
    name: 'Olhar Digital',
    ...
    category: 'Tecnologia',
    tags: ['olhar digital', 'tecnologia', 'inovação'],
  },
  {
    id: 'canaltech',
    name: 'Canaltech',
    ...
    category: 'Tecnologia',
    tags: ['canaltech', 'tecnologia', 'software', 'hardware'],
  },
  {
    id: 'techcrunch',
    name: 'TechCrunch',
    ...
    category: 'Tecnologia',
    tags: ['techcrunch', 'startups', 'tech', 'silicon valley'],
  },
  {
    id: 'theverge',
    name: 'The Verge',
    ...
    category: 'Tecnologia',
    tags: ['verge', 'tech', 'gadgets', 'reviews'],
  },
  {
    id: 'arstechnica',
    name: 'Ars Technica',
    ...
    category: 'Tecnologia',
    tags: ['ars', 'technica', 'technology', 'science'],
  },
  {
    id: 'wired',
    name: 'Wired',
    ...
    category: 'Tecnologia',
    tags: ['wired', 'tech', 'innovation', 'future'],
  },
  {
    id: 'hackernews',
    name: 'Hacker News',
    ...
    category: 'Tecnologia',
    tags: ['hacker news', 'hn', 'ycombinator', 'programming', 'dev'],
  },
  {
    id: 'tecnoblog',
    name: 'Tecnoblog',
    ...
    category: 'Tecnologia',
    tags: ['tecnoblog', 'brasil', 'tecnologia', 'gadgets'],
  },
  {
    id: 'engadget',
    name: 'Engadget',
    ...
    category: 'Tecnologia',
    tags: ['engadget', 'gadgets', 'reviews', 'tech'],
  },
  {
    id: 'mashable',
    name: 'Mashable',
    ...
    category: 'Tecnologia',
    tags: ['mashable', 'social media', 'tech', 'culture'],
  },
  {
    id: 'zdnet',
    name: 'ZDNet',
    ...
    category: 'Tecnologia',
    tags: ['zdnet', 'enterprise', 'tech', 'software'],
  },
  {
    id: 'thenextweb',
    name: 'The Next Web',
  ...
  },
  {
    ...
    category: 'Tecnologia',
    tags: ['gizmodo', 'gadgets', 'science', 'design'],
  },
  {
    id: 'mit-tech-review',
    ...
    category: 'Tecnologia',
    tags: ['mit', 'technology review', 'ai', 'innovation', 'research'],
  },
  {
    id: 'venturebeat',
    name: 'VentureBeat',
    ...
    category: 'Tecnologia',
    tags: ['venturebeat', 'ai', 'startups', 'enterprise'],
  },
  {
    id: 'techradar',
    name: 'TechRadar',
    ...
    category: 'Tecnologia',
    tags: ['techradar', 'reviews', 'gadgets', 'phones'],
  },
  {
    id: 'showmetech',
    name: 'Showmetech',
    ...
    category: 'Tecnologia',
    tags: ['showmetech', 'brasil', 'reviews', 'smartphones'],
  },
  {
    id: 'mundo-conectado',
    ...
    category: 'Tecnologia',
    tags: ['mundo conectado', 'brasil', 'reviews', 'tech'],
  },
  {
    id: 'tudo-celular',
    name: 'Tudo Celular',
    ...
    category: 'Tecnologia',
    tags: ['tudo celular', 'smartphones', 'celular', 'android', 'iphone'],
  },
  {
    id: 'openai-blog',
    name: 'OpenAI Blog',
    ...
    category: 'Tecnologia',
    tags: ['openai', 'chatgpt', 'ai', 'inteligência artificial', 'gpt'],
  },
  {
    id: 'google-ai-blog',
    name: 'Google AI Blog',
    ...
    category: 'Tecnologia',
    tags: ['google', 'ai', 'gemini', 'deepmind', 'machine learning'],
  },
  {
    id: 'dev-to',
    name: 'DEV Community',
    ...
    category: 'Tecnologia',
    tags: ['dev', 'programming', 'desenvolvimento', 'code', 'web'],
  },
  {
    id: 'css-tricks',
    name: 'CSS-Tricks',
    ...
    category: 'Tecnologia',
    tags: ['css', 'frontend', 'web', 'design', 'html', 'javascript'],
  },
  {
    id: 'smashing',
    ...
    category: 'Tecnologia',
    tags: ['smashing', 'web design', 'ux', 'frontend'],
  },
  // Mundo
  {
    id: 'g1-mundo',
    ...
    category: 'Mundo',
    tags: ['globo', 'mundo', 'internacional'],
  },
  {
    id: 'folha-mundo',
    name: 'Folha Mundo',
    ...
    category: 'Mundo',
    tags: ['folha', 'mundo', 'internacional'],
  },
  {
    id: 'bbc-news',
    name: 'BBC News',
  ...
  },
  {
    ...
    category: 'Mundo',
    tags: ['reuters', 'world', 'agência', 'internacional'],
  },
  {
    id: 'aljazeera',
    name: 'Al Jazeera',
    ...
    category: 'Mundo',
    tags: ['aljazeera', 'middle east', 'mundo', 'internacional'],
  },
  {
    id: 'france24',
    name: 'France 24',
    ...
    category: 'Mundo',
    tags: ['france', 'europa', 'france24', 'internacional'],
  },
  {
    id: 'nyt',
    ...
    category: 'Mundo',
    tags: ['nyt', 'new york', 'times', 'eua', 'estados unidos'],
  },
  {
    id: 'guardian',
    name: 'The Guardian',
    ...
    category: 'Mundo',
    tags: ['guardian', 'uk', 'england', 'world'],
  },
  {
    id: 'cnn',
    ...
    category: 'Mundo',
    tags: ['cnn', 'eua', 'world', 'international'],
  },
  {
    id: 'ap-news',
    ...
    category: 'Mundo',
    tags: ['ap', 'associated press', 'world', 'agência'],
  },
  {
    id: 'nyt-world',
    name: 'NYT World',
    ...
    category: 'Mundo',
    tags: ['nyt', 'world', 'international', 'global'],
  },
  {
    id: 'bbc-world',
    name: 'BBC World',
  ...
  },
  {
    ...
    category: 'Mundo',
    tags: ['el país', 'espanha', 'spain', 'español'],
  },
  {
    id: 'le-monde',
    name: 'Le Monde',
  ...
  },
  {
    ...
    category: 'Mundo',
    tags: ['spiegel', 'germany', 'europe', 'international'],
  },
  {
    id: 'japan-times',
    ...
    category: 'Mundo',
    tags: ['japan', 'asia', 'tokyo', 'japanese'],
  },
  {
    id: 'scmp',
    ...
    category: 'Mundo',
    tags: ['scmp', 'china', 'hong kong', 'asia'],
  },
  // Esportes
  {
    id: 'ge',
    ...
    category: 'Esportes',
    tags: ['ge', 'globo esporte', 'futebol', 'esportes'],
  },
  {
    id: 'folha-esporte',
    name: 'Folha Esporte',
  ...
  },
  {
    ...
    category: 'Esportes',
    tags: ['espn', 'esportes', 'futebol', 'nba', 'nfl'],
  },
  {
    id: 'tnt-sports',
    name: 'TNT Sports',
    url: 'https://www.tntsports.com.br/feed/',
    category: 'Esportes',
    tags: ['tnt', 'sports', 'champions league', 'futebol'],
  },
  {
    id: 'terceiro-tempo',
    name: 'Terceiro Tempo',
    url: 'https://terceirotempo.uol.com.br/feed/',
    category: 'Esportes',
    tags: ['terceiro tempo', 'futebol', 'história'],
  },
  {
    id: 'bbc-sport',
    name: 'BBC Sport',
    ...
    category: 'Esportes',
    tags: ['bbc', 'sport', 'football', 'soccer', 'premier league'],
  },
  {
    id: 'espn',
    name: 'ESPN',
  ...
  },
  {
    ...
    category: 'Esportes',
    tags: ['sky', 'sports', 'premier league', 'football'],
  },
  {
    id: 'ge-futebol',
    name: 'ge Futebol',
    ...
    category: 'Esportes',
    tags: ['ge', 'futebol', 'brasileirão', 'copa'],
  },
  {
    id: 'ge-f1',
    name: 'ge Fórmula 1',
    ...
    category: 'Esportes',
    tags: ['ge', 'formula 1', 'f1', 'automobilismo', 'corrida'],
  },
  {
    id: 'surfe-globo',
    name: 'ge Surfe',
    url: 'https://ge.globo.com/rss/ge/surfe/',
    category: 'Esportes',
    tags: ['surfe', 'surf', 'wsl', 'ondas'],
  },
  // Ciência
  {
    id: 'g1-ciencia',
    ...
    category: 'Ciência',
    tags: ['globo', 'ciência', 'saúde', 'pesquisa'],
  },
  {
    id: 'nature',
    name: 'Nature',
    ...
    category: 'Ciência',
    tags: ['nature', 'science', 'research', 'papers'],
  },
  {
    id: 'sciencedaily',
    name: 'ScienceDaily',
    ...
    category: 'Ciência',
    tags: ['science', 'daily', 'research', 'discovery'],
  },
  {
    id: 'nasa',
    name: 'NASA',
    ...
    category: 'Ciência',
    tags: ['nasa', 'space', 'espaço', 'astronomia'],
  },
  {
    ...
    category: 'Ciência',
    tags: ['super', 'interessante', 'ciência', 'curiosidades'],
  },
  {
    id: 'science-mag',
    ...
    category: 'Ciência',
    tags: ['science', 'magazine', 'research', 'papers'],
  },
  {
    id: 'new-scientist',
    name: 'New Scientist',
    ...
    category: 'Ciência',
    tags: ['new scientist', 'science', 'discovery'],
  },
  {
    id: 'space-com',
    name: 'Space.com',
    ...
    category: 'Ciência',
    tags: ['space', 'astronomy', 'espaço', 'universe'],
  },
  {
    id: 'phys-org',
    name: 'Phys.org',
    ...
    category: 'Ciência',
    tags: ['physics', 'technology', 'science', 'research'],
  },
  {
    id: 'nat-geo',
    ...
    category: 'Ciência',
    tags: ['nat geo', 'national geographic', 'natureza', 'animais'],
  },
  {
    id: 'galileu',
    name: 'Galileu',
    ...
    category: 'Ciência',
    tags: ['galileu', 'ciência', 'tecnologia', 'brasil'],
  },
  {
    id: 'science-alert',
    name: 'ScienceAlert',
    ...
    category: 'Ciência',
    tags: ['sciencealert', 'science', 'discovery', 'space'],
  },
  {
    id: 'eso',
    name: 'ESO (Observatório Europeu)',
    url: 'https://www.eso.org/public/news/feed/',
    category: 'Ciência',
    tags: ['eso', 'astronomy', 'telescope', 'europe'],
  },
  // Entretenimento
  {
    id: 'omelete',
    ...
    tags: ['omelete', 'cinema', 'séries', 'filmes', 'games', 'hq'],
  },
  {
    id: 'adoro-cinema',
    name: 'AdoroCinema',
    url: 'https://www.adorocinema.com/rss/',
    category: 'Entretenimento',
    tags: ['cinema', 'filmes', 'séries', 'críticas'],
  },
  {
    id: 'ign-br',
    name: 'IGN Brasil',
    ...
    category: 'Entretenimento',
    tags: ['ign', 'games', 'jogos', 'reviews', 'gaming'],
  },
  {
    id: 'eurogamer',
    name: 'Eurogamer',
    ...
    category: 'Entretenimento',
    tags: ['eurogamer', 'games', 'reviews', 'pc', 'console'],
  },
  {
    id: 'kotaku',
    name: 'Kotaku',
    ...
    category: 'Entretenimento',
    tags: ['kotaku', 'games', 'gaming', 'culture'],
  },
  {
    id: 'polygon',
    name: 'Polygon',
    ...
    category: 'Entretenimento',
    tags: ['polygon', 'games', 'entertainment', 'reviews'],
  },
  {
    id: 'gamespot',
    name: 'GameSpot',
    ...
    category: 'Entretenimento',
    tags: ['gamespot', 'games', 'reviews', 'trailers'],
  },
  {
    id: 'cinema-blend',
    name: 'CinemaBlend',
    url: 'https://www.cinemablend.com/rss/topic/news/all',
    category: 'Entretenimento',
    tags: ['cinema', 'movies', 'tv', 'streaming'],
  },
  {
    id: 'variety',
    name: 'Variety',
    ...
    category: 'Entretenimento',
    tags: ['variety', 'hollywood', 'cinema', 'tv', 'streaming'],
  },
  {
    id: 'deadline',
    name: 'Deadline',
    ...
    category: 'Entretenimento',
    tags: ['deadline', 'hollywood', 'film', 'tv'],
  },
  {
    id: 'screen-rant',
    name: 'Screen Rant',
    ...
    category: 'Entretenimento',
    tags: ['screen rant', 'movies', 'tv', 'comics', 'marvel'],
  },
  {
    id: 'musicradar',
    name: 'MusicRadar',
    ...
    category: 'Entretenimento',
    tags: ['music', 'guitars', 'instruments', 'production'],
  },
  {
    id: 'pitchfork',
    name: 'Pitchfork',
    ...
    category: 'Entretenimento',
    tags: ['pitchfork', 'music', 'reviews', 'albums', 'indie'],
  },
  {
    id: 'veja',
    name: 'Veja',
    ...
    category: 'Entretenimento',
    tags: ['veja', 'revista', 'cultura', 'brasil'],
  },
  {
    id: 'pop-sugar',
    name: 'PopSugar',
    ...
    category: 'Entretenimento',
    tags: ['popsugar', 'celebrity', 'culture', 'lifestyle'],
  },
  // Saúde
  {
    id: 'folha-saude',
    ...
    category: 'Saúde',
    tags: ['folha', 'saúde', 'equilíbrio', 'medicina'],
  },
  {
    id: 'medical-news',
    ...
    category: 'Saúde',
    tags: ['medical', 'health', 'medicine', 'research'],
  },
  {
    id: 'webmd',
    name: 'WebMD',
    ...
    category: 'Saúde',
    tags: ['webmd', 'health', 'medicine', 'wellness'],
  },
  {
    id: 'viva-bem',
    name: 'VivaBem (UOL)',
    ...
    category: 'Saúde',
    tags: ['vivabem', 'uol', 'saúde', 'bem-estar', 'fitness'],
  },
  // Educação
  {
    id: 'g1-educacao',
    ...
    category: 'Educação',
    tags: ['globo', 'educação', 'enem', 'vestibular', 'escola'],
  },
  {
    id: 'folha-educacao',
    name: 'Folha Educação',
    ...
    category: 'Educação',
    tags: ['folha', 'educação', 'ensino', 'universidade'],
  },
  {
    id: 'quero-bolsa',
    name: 'Quero Bolsa',
    url: 'https://querobolsa.com.br/revista/feed',
    category: 'Educação',
    tags: ['quero bolsa', 'faculdade', 'bolsa', 'estudos'],
  },
  // Meio Ambiente
  {
    id: 'oeco',
    ...
    tags: ['o eco', 'meio ambiente', 'ecologia', 'sustentabilidade'],
  },
  {
    id: 'um-so-planeta',
    name: 'Um Só Planeta',
    url: 'https://umsoplaneta.globo.com/feed/',
    category: 'Meio Ambiente',
    tags: ['planeta', 'globo', 'sustentabilidade', 'clima'],
  },
  {
    id: 'mongabay',
    name: 'Mongabay',
    ...
    category: 'Meio Ambiente',
    tags: ['mongabay', 'rainforest', 'biodiversity', 'environment'],
  },
  {
    id: 'treehugger',
    name: 'Treehugger',
    ...
    category: 'Meio Ambiente',
    tags: ['treehugger', 'sustainability', 'green', 'environment'],
  },
  // Negócios
  {
    id: 'startse',
    ...
    category: 'Negócios',
    tags: ['startse', 'startups', 'empreendedorismo', 'inovação'],
  },
  {
    ...
    category: 'Negócios',
    tags: ['pegn', 'pequenas empresas', 'negócios', 'empreendedorismo'],
  },
  {
    id: 'epoca-negocios',
    name: 'Época Negócios',
    url: 'https://epocanegocios.globo.com/feed/',
    category: 'Negócios',
    tags: ['época', 'negócios', 'empresas', 'gestão'],
  },
  {
    id: 'harvard-br',
    name: 'HBR Brasil',
    url: 'https://hbrbr.com.br/feed/',
    category: 'Negócios',
    tags: ['harvard', 'business review', 'gestão', 'liderança'],
  },
  {
    id: 'fast-company',
    name: 'Fast Company',
    ...
    category: 'Negócios',
    tags: ['fast company', 'innovation', 'design', 'business'],
  },
  {
    id: 'inc',
    name: 'Inc.',
    ...
    category: 'Negócios',
    tags: ['inc', 'startups', 'entrepreneurship', 'business'],
  },
  // Segurança
  {
    id: 'krebs',
  ...
  },
  {
    ...
    category: 'Segurança',
    tags: ['threatpost', 'security', 'vulnerabilities', 'malware'],
  },
  {
    id: 'bleeping',
    ...
    category: 'Segurança',
    tags: ['bleeping', 'security', 'ransomware', 'malware'],
  },
  {
    id: 'hacker-news-sec',
    ...
    category: 'Segurança',
    tags: ['hacker news', 'cybersecurity', 'infosec', 'data breach'],
  },
  {
    id: 'dark-reading',
    name: 'Dark Reading',
    ...
    category: 'Segurança',
    tags: ['dark reading', 'cybersecurity', 'enterprise', 'threats'],
  },
  // Design
  {
    id: 'designboom',
    ...
    category: 'Design',
    tags: ['designboom', 'architecture', 'art', 'design'],
  },
  {
    id: 'dezeen',
    name: 'Dezeen',
    ...
    category: 'Design',
    tags: ['dezeen', 'architecture', 'design', 'interiors'],
  },
  {
    id: 'archdaily-br',
    ...
    category: 'Design',
    tags: ['archdaily', 'arquitetura', 'design', 'brasil'],
  },
  {
    id: 'behance',
    name: 'Behance',
    ...
    category: 'Design',
    tags: ['behance', 'portfolio', 'creative', 'graphic design'],
  },
  // Linux / Open Source
  {
    id: 'omgubuntu',
    ...
    category: 'Tecnologia',
    tags: ['ubuntu', 'linux', 'open source', 'desktop'],
  },
  {
    id: 'phoronix',
    name: 'Phoronix',
    ...
    category: 'Tecnologia',
    tags: ['phoronix', 'linux', 'benchmark', 'hardware', 'open source'],
  },
  {
    id: 'itsfoss',
    name: "It's FOSS",
    ...
    category: 'Tecnologia',
    tags: ['foss', 'linux', 'open source', 'ubuntu', 'tutorials'],
  },
  {
    id: 'diolinux',
    name: 'Diolinux',
    ...
    category: 'Tecnologia',
    tags: ['diolinux', 'linux', 'open source', 'brasil'],
  },
];
...
function searchCurated(query: string): RssSuggestion[] {
  ...
  for (const entry of DIRECTORY) {
    ...
    if (qWords.length > 1) {
      const allMatch = qWords.every((w) => nName.includes(w) || nCat.includes(w) || nTags.some((t) => t.includes(w)));
...
- Se não conhecer feeds para o termo, retorne um array vazio [].`;
    ...
    const results = parsed
      .filter(
        (item): item is { name: string; url: string; category: string } =>
          Boolean(item.name) && Boolean(item.url) && Boolean(item.category),
      )
      .slice(0, 5)
      .map((item, index) => ({
    ...
    if (db) {
      ...
      (async () => {
        try {
          ...
          console.warn('[telemetry] ai_usage_logs INSERT failed:', e instanceof Error ? e.message : e);
        }
      })();
    }
